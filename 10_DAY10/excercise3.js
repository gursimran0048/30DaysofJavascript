...
const countriesData = [
  ...
  console.log('Number of languages in the countries object file:', numberOfLanguages);
...
//   ]
  function mostSpokenLanguages(countries, limit) {
    ...
    return sortedLanguages.slice(0, limit).map(([language, count]) => ({ [language]: count }));
  }
  
  const topTenLanguages = mostSpokenLanguages(countries, 10);
