...
countriesData.forEach(({name,population,capital,languages,flag,currency })=>console.log(name,population,capital,languages,flag,currency))
...
function convertArrayToObject(arr){
  ...
  const newArr= arr.map((([name,skills,scores])=>{
        let obj = {
            name:name,
            skills:skills,
            scores:scores
...
const student1 = {
  ...
  const newStudent = {
    ...
    skills: {
      ...student1.skills,
      frontEnd: [
        ...student1.skills.frontEnd,
        { skill: 'Bootstrap', level: 8 },
      ],
      backEnd: [
        ...student1.skills.backEnd,
        { skill: 'Express', level: 9 },
      ],
      dataBase: [
        ...student1.skills.dataBase,
        { skill: 'SQL', level: 8 },
      ],
      dataScience: [...student1.skills.dataScience, 'SQL'],
    }
  };
